...
async def list_bouts(service: BoutService = Depends(get_service(BoutService))) -> MainResponse[list[BoutResponse]]:
    bouts = await service.list()
    return get_ok[MainResponse[list[BoutResponse]]](BoutResponse.from_entity_list(bouts))
...
async def get_bout(
    ...
    return get_ok[MainResponse[BoutResponse]](BoutResponse.from_entity(bout))
...
async def create_bout(
    ...
    return get_ok[MainResponse[BoutResponse]](BoutResponse.from_entity(created))
