...
from elo_calculator.application.services.pre_ufc_bout_service import PreUfcBoutService
...
router = APIRouter(prefix='/pre-ufc-bouts', tags=['pre-ufc-bouts'])


@router.get('/by-fighter/{fighter_id}', response_model=MainResponse[list[PreUfcBoutResponse]])
