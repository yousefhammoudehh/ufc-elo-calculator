...
async def list_by_bout(
    ...
    return get_ok[MainResponse[list[BoutParticipantResponse]]](BoutParticipantResponse.from_entity_list(participants))
...
async def get_bout_participant(
    ...
    return get_ok[MainResponse[BoutParticipantResponse]](BoutParticipantResponse.from_entity(participant))
