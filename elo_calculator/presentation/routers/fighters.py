...
async def list_fighters(
    ...
    return get_ok[MainResponse[list[FighterResponse]]](FighterResponse.from_entity_list(fighters))
...
async def get_fighter(
    ...
    return get_ok[MainResponse[FighterResponse]](FighterResponse.from_entity(fighter))
...
async def create_fighter(
    ...
    return get_ok[MainResponse[FighterResponse]](FighterResponse.from_entity(created))
