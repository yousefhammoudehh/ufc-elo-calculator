...
from olive_template.domain.shared.exceptions import DomainException
from olive_template.infrastructure.shared.exceptions import DatabaseError, ExternalServiceError
from olive_template.presentation.utils.response import (
